...
class Authentication {
  ...
  getClientSecret(){
    return require('./data-3c155f5283bc.json');
  }
  authorize(credentials) {
    var clientSecret = "WvracvXUvJ72gT00svN-YzBU";
    var clientId = "205848802347-39qar08lcv7259f0g88rrmeksjlampdh.apps.googleusercontent.com";
    var redirectUrl = "localhost:4200";
